...
namespace COMP717.ConnectFour {
    class ConnectFourTree {
        ...
        public ConnectFourTree(Grid start, char turn, int depth = Int32.MaxValue) {
            root = GenerateTree(new Node(0, new Grid((char[,])start.GetState().Clone()), new int[] { 0, 0 }), turn, depth);
